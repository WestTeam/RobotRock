...
#ifndef WESTBOT_ROBOTROCK_STRATEGYMANAGERMATCH5_HPP_
#define WESTBOT_ROBOTROCK_STRATEGYMANAGERMATCH5_HPP_
 ...
 */
class StrategyManagerMatch5 : public StrategyManager
{
public:
    StrategyManagerMatch5( QObject* parent = nullptr );

    ~StrategyManagerMatch5() override = default;
...
#endif // WESTBOT_ROBOTROCK_STRATEGYMANAGERMatch5_HPP_
