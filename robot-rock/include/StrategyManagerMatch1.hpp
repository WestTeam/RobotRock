...
#ifndef WESTBOT_ROBOTROCK_STRATEGYMATCH1_HPP_
#define WESTBOT_ROBOTROCK_STRATEGYMATCH1_HPP_
 ...
 */
class StrategyManagerMatch1 : public StrategyManager
{
public:
    StrategyManagerMatch1( QObject* parent = nullptr );

    ~StrategyManagerMatch1() override = default;
