...
#ifndef WESTBOT_ROBOTROCK_STRATEGYMATCH2_HPP_
#define WESTBOT_ROBOTROCK_STRATEGYMATCH2_HPP_
 ...
 */
class StrategyManagerMatch2 : public StrategyManager
{
public:
    StrategyManagerMatch2( QObject* parent = nullptr );

    ~StrategyManagerMatch2() override = default;
...
#endif // WESTBOT_ROBOTROCK_STRATEGYMATCH1_HPP_
