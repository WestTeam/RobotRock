...
#ifndef WESTBOT_ROBOTROCK_STRATEGYMANAGERMATCH3_HPP_
#define WESTBOT_ROBOTROCK_STRATEGYMANAGERMATCH3_HPP_
 ...
 */
class StrategyManagerMatch3 : public StrategyManager
{
public:
    StrategyManagerMatch3( QObject* parent = nullptr );

    ~StrategyManagerMatch3() override = default;
...
#endif // WESTBOT_ROBOTROCK_STRATEGYMANAGERMATCH3_HPP_
