...
StrategyManagerMatch5::StrategyManagerMatch5( QObject* parent )
    : _odometry( nullptr )
    , _recalage( nullptr )
...
bool StrategyManagerMatch5::init(
...
void StrategyManagerMatch5::deinit()
{
    _opponentDetection = nullptr;
    _armsManager = nullptr;
    _recalage = nullptr;
...
void StrategyManagerMatch5::stop()
{
    hardStop();
...
// Private methods
void StrategyManagerMatch5::buildStrat( const Color& color )
{
    float inv = 1.0;
    float shift = 0.0;
    float offset = 0.0;
...
void StrategyManagerMatch5::doStrat( const Color& color )
{
...
void StrategyManagerMatch5::hardStop()
{
...
void StrategyManagerMatch5::obstacleAt( double xStart, double yStart, double xEnd, double yEnd )
{
