...
StrategyManagerMatch2::StrategyManagerMatch2( QObject* parent )
    : _odometry( nullptr )
    , _recalage( nullptr )
...
bool StrategyManagerMatch2::init(
...
void StrategyManagerMatch2::deinit()
{
    _opponentDetection = nullptr;
    _armsManager = nullptr;
    _recalage = nullptr;
...
void StrategyManagerMatch2::stop()
{
    hardStop();
...
// Private methods
void StrategyManagerMatch2::buildStrat( const Color& color )
{
    float inv = 1.0;
    float shift = 0.0;
    float offset = 0.0;
...
/*
    ...
    fakePuckLine1.z = 120.0;
    fakePuckLine1.x = 15;
    fakePuckLine1.y = (1500-1000.0+150.0)*inv*-1.0;

    fakePuckLine2.isOnGround = false;
    fakePuckLine2.z = 120.0;
    fakePuckLine2.x = 15;
    fakePuckLine2.y = (1500-1000.0-150.0)*inv*-1.0;
...
void StrategyManagerMatch2::doStrat( const Color& color )
{
...
void StrategyManagerMatch2::hardStop()
{
...
void StrategyManagerMatch2::obstacleAt( double xStart, double yStart, double xEnd, double yEnd )
{
